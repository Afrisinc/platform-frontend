    ...
    products: [
      {
        ...
        icon: "Bell",
        color: "202 97% 45%",
        url: "/workspace/ws_1/notify",
        active: true,
      },
      {
        id: "pay",
        name: "Pay",
        description: "Payments infrastructure for Africa",
        icon: "CreditCard",
        color: "152 60% 42%",
        url: "/workspace/ws_1/pay",
        active: true,
      },
      {
        id: "vpn",
        name: "VPN",
        description: "Secure network access for teams",
        icon: "Shield",
        color: "270 60% 55%",
        url: "/workspace/ws_1/vpn",
        active: true,
      },
    ],
  },
